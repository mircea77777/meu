...
public class UserServiceImpl implements UserService {
   ...
   /*  public User followOtherUser(String userName) {
    ...
    @Override
    public UserDTO follow(UserDTO userDTOFollower, UserDTO userDTOFollowing) {
    	User userToFollow = userRepository.follow(UserMapper.convertToEntity(userDTOFollower), UserMapper.convertToEntity(userDTOFollowing));
